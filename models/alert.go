...
type Alert struct {
	...
	Status         int           `json:"status,omitempty" form:"status" gorm:"comment:状态(0:未读 1:已读)"`
	ResolvedStatus int           `json:"resolvedStatus,omitempty" form:"resolvedStatus" gorm:"comment:处置状态(0:未处置 1:已手动处置 2:自动处置)"`
